                        ...
                        <>
                            {user?.role === 'admin' ? (
                                <div className="flex items-center gap-4">
                                    <Link to="/admin" className="hover:text-gold-500 transition-colors font-medium">Manage Sweets</Link>
                                    <Link to="/admin?create=true" className="bg-gold-500 text-white px-4 py-2 rounded-lg hover:bg-gold-600 transition-colors text-sm font-medium">
                                        + Add Sweet
                                    </Link>
                                </div>
                            ) : (
                                <Link to="/orders" className="hover:text-gold-500 transition-colors font-medium">Orders</Link>
                            )}
